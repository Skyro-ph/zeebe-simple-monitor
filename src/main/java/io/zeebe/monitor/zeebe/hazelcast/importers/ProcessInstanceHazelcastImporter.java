...
@Component
public class ProcessInstanceHazelcastImporter implements Importer<Schema.ProcessInstanceRecord> {
    ...
    public Set<String> supportedTypes() {
        return Set.of("PROCESS_INSTANCE");
    }
    ...
    @Override
    public void importData(final Schema.ProcessInstanceRecord record) {
